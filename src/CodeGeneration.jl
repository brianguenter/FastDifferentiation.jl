...
#TODO need to figure out if it is okay to call promote_type in this case. The docs say should use promote_rule instead but that doesn't seem to apply here.
